...
public class PolisiActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    String GET_JSON_DATA_HTTP_URL = "http://insapol.esy.es/skripsi/data/haverslinePolisi.php?lat=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Polisi");
    ...
    private void lokasi() {
        ...
        if (!locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER)){
            ...
            alertDialogBuilder
                    ...
                    .setPositiveButton("Back",new DialogInterface.OnClickListener(){
                        public void onClick(DialogInterface dialog,int id) {
                            PolisiActivity.super.onBackPressed();
                        }
                    });
            ...
            if (latitude != null && lngitude != null) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(PolisiActivity.this);
