package com.skripsi.gis.bekasipatriot.activity.DetailActivity;
...
import com.skripsi.gis.bekasipatriot.activity.DetailActivity.PelayananCardView.Adapter.AdapterDetail;
import com.skripsi.gis.bekasipatriot.activity.DetailActivity.PelayananCardView.Model.ModelDetail;
...
public class DetailActivity extends AppCompatActivity{
    ...
    List<ModelDetail> GetDataAdapter1 = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        instansiJarak.setText(String.valueOf(jarakInstansi) + " km");
    ...
    public void JSON_PARSE_DATA(JSONArray array) {
        for (int i = 0; i < array.length(); i++) {
            ModelDetail GetDataAdapter2 = new ModelDetail();
