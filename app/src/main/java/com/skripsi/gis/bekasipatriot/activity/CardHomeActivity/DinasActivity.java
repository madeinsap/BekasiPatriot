...
public class DinasActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    String GET_JSON_DATA_HTTP_URL = "http://insapol.esy.es/skripsi/data/haverslineDinas.php?lat=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Dinas");
    ...
    private void lokasi() {
        ...
        if (!locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER)){
            ...
            alertDialogBuilder
                    ...
                    .setPositiveButton("Back",new DialogInterface.OnClickListener(){
                        public void onClick(DialogInterface dialog,int id) {
                            DinasActivity.super.onBackPressed();
                        }
                    });
            ...
            if (latitude != null && lngitude != null) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(DinasActivity.this);
    ...
    public void JSON_DATA_WEB_CALL() {
        ...
        String link = GET_JSON_DATA_HTTP_URL + latitude + "&lng=" + lngitude;
        Log.d("output", "link = " + link);
        jsonArrayRequest = new JsonArrayRequest(link,
