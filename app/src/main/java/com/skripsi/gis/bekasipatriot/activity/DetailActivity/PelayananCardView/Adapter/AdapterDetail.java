package com.skripsi.gis.bekasipatriot.activity.DetailActivity.PelayananCardView.Adapter;
...
public class AdapterDetail extends RecyclerView.Adapter<AdapterDetail.ViewHolder> {
    ...
    Context context;
    List<ModelDetail> getDataAdapter;

    public AdapterDetail(List<ModelDetail> getDataAdapter, Context context){
        super();
    ...
    public void onBindViewHolder(final AdapterDetail.ViewHolder holder, final int position) {
        ModelDetail getDataAdapter1 =  getDataAdapter.get(position);
