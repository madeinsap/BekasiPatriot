...
public class KecamatanActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    String GET_JSON_DATA_HTTP_URL = "http://insapol.esy.es/skripsi/data/haverslineKecamatan.php?lat=";
    ...
    private void lokasi() {
        ...
        if (!locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER)){
            ...
            alertDialogBuilder
                    ...
                    .setPositiveButton("Back",new DialogInterface.OnClickListener(){
                        public void onClick(DialogInterface dialog,int id) {
                            KecamatanActivity.super.onBackPressed();
                        }
                    });
            ...
            if (latitude != null && lngitude != null) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(KecamatanActivity.this);
